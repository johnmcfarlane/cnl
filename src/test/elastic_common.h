...
static_assert(sizeof(make_elastic<255, char>()) == 1, "using too many bytes to represent 255");
...
static_assert(sizeof(make_elastic<510, char>()) == 1, "using too many bytes to represent 510");
