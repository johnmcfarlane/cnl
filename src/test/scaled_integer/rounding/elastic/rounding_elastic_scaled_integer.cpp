...
namespace {
    ...
    namespace test_ctor {
        static_assert(
                identical(
                        ...
                        rounding_elastic_scaled_integer<24, -20>{rounding_elastic_scaled_integer<49, -40>{1.5}}),
                "");
#if defined(CNL_INT128_ENABLED)
        static_assert(
                identical(
                        rounding_elastic_scaled_integer<48, -40>{1.5},
                        rounding_elastic_scaled_integer<48, -40>{rounding_elastic_scaled_integer<97, -80>{1.5}}),
                "");
#endif
    }
    ...
    namespace test_addition {
        static_assert(
                identical(
                        ...
                        rounding_elastic_scaled_integer<16>{1}+rounding_elastic_scaled_integer<16, -8>{1}),
                "rounding_elastic_scaled_integer addition");
#if defined(CNL_INT128_ENABLED)
        static_assert(
                identical(
                        rounding_elastic_scaled_integer<63, -30>{2LL},
                        rounding_elastic_scaled_integer<32>{1}+rounding_elastic_scaled_integer<32, -30>{1}),
    ...
    namespace test_shift {
        ...
        static_assert(identical(rounding_elastic_scaled_integer<16, -8>{2}, a << 1), "rounding_elastic_scaled_integer shift");
        static_assert(identical(rounding_elastic_scaled_integer<16, -8>{.5}, a >> 1), "rounding_elastic_scaled_integer shift");
        static_assert(identical(rounding_elastic_scaled_integer<16, -8>{1}, a << 0), "rounding_elastic_scaled_integer shift");
        static_assert(identical(rounding_elastic_scaled_integer<16, -8>{1}, a >> 0), "rounding_elastic_scaled_integer shift");
    }
    ...
    namespace test_division {
        ...
        static_assert(identical(
                ...
                cnl::quotient(rounding_elastic_scaled_integer<31, 0>{2}, rounding_elastic_scaled_integer<31, 0>{1})),
                      "cnl::quotient(rounding_elastic_scaled_integer, rounding_elastic_scaled_integer)");

#if defined(CNL_INT128_ENABLED)
        static_assert(identical(
                rounding_elastic_scaled_integer<96, -48>{2.},
                cnl::quotient(rounding_elastic_scaled_integer<48, 0>{2}, rounding_elastic_scaled_integer<48, 0>{1})),
                          "cnl::quotient(rounding_elastic_scaled_integer, rounding_elastic_scaled_integer)");
#endif

        static_assert(identical(
                rounding_elastic_scaled_integer<16, -8>{.5},
                cnl::quotient(rounding_elastic_scaled_integer<8, -4>{1}, rounding_elastic_scaled_integer<8, -4>{2})),
                      "cnl::quotient(rounding_elastic_scaled_integer, rounding_elastic_scaled_integer)");
        ...
        static_assert(identical(
                ...
                make_scaled_integer(cnl::make_fraction(
                        ...
                        rounding_elastic_scaled_integer<8, 0>{2}))), "cnl::rounding_elastic_scaled_integer division");

        static_assert(identical(
                rounding_elastic_scaled_integer<62, -31>{.5},
                make_scaled_integer(cnl::make_fraction(
                        rounding_elastic_scaled_integer<31, 0>{1},
                        rounding_elastic_scaled_integer<31, 0>{2}))), "cnl::rounding_elastic_scaled_integer division");
        ...
        static_assert(identical(
                ...
                make_scaled_integer(cnl::make_fraction(
                        ...
                        rounding_elastic_scaled_integer<48, 0>{2}))), "cnl::rounding_elastic_scaled_integer division");
    ...
    namespace test_static_cast {
        ...
        static_assert(identical(rounding_elastic_scaled_integer<24, -20>{0.21875}, c), "rounding_elastic_scaled_integer assignment");
#endif
    }
}
