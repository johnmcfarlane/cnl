...
static_assert(is_same<_impl::common_repr_type<uint8, uint8>, uint8>::value,
        "sg14::_impl::common_repr_type test failed");
static_assert(is_same<_impl::common_repr_type<int8, uint64>, int64>::value,
        "sg14::_impl::common_repr_type test failed");
static_assert(is_same<_impl::common_repr_type<uint32, int8>, int32>::value,
        "sg14::_impl::common_repr_type test failed");
static_assert(is_same<_impl::common_repr_type<int16, int16>, int16>::value,
        "sg14::_impl::common_repr_type test failed");
...
static_assert(is_same<_impl::common_type<fixed_point<uint8, -4>, fixed_point<int8, -4>>, fixed_point<int8, -3>>::value,
        "sg14::_impl::common_type test failed");
static_assert(
...
static_assert(is_same<_impl::common_type<int8, fixed_point<uint64, -60>>, fixed_point<uint64, -60>>::value,
        "sg14::_impl::common_type test failed");
static_assert(is_same<_impl::common_type<fixed_point<uint8, -4>, uint32>, fixed_point<uint8, -4>>::value,
        "sg14::_impl::common_type test failed");
...
static_assert(_impl::divide<fixed_point<>>(fixed_point<>(15), fixed_point<>(2))==15/2,
        "sg14::_impl::multiply test failed");
static_assert(_impl::divide<make_fixed<1, 14>>(make_fixed<1, 6>(1), make_fixed<7, 0>(127))==make_fixed<1, 14>(1./127),
...
static_assert(is_same<decltype(make_fixed<2, 5>(2.125)+make_fixed<2, 5>(-3.25)), make_fixed<2, 5>>::value,
        "arithmetic operators test failed");

static_assert(fixed_point<uint8, 10>(10240)+2048==12288, "arithmetic operators test failed");
static_assert(is_same<decltype(fixed_point<uint8, 10>(10240)+2048), fixed_point<uint8, 10>>::value,
        "arithmetic operators test failed");
static_assert(2048+fixed_point<uint8, 10>(10240)==12288, "arithmetic operators test failed");
static_assert(is_same<decltype(2048+fixed_point<uint8, 10>(10240)), fixed_point<uint8, 10>>::value,
        "arithmetic operators test failed");
...
static_assert(is_same<decltype(make_fixed<2, 5>(2.5)/make_fixed<2, 5>(-4.f)), make_fixed<2, 5>>::value,
        "arithmetic operators test failed");
...
static_assert(is_same<trunc_add_result<fixed_point<int8, 0>, 2>, fixed_point<int8, 1>>::value,
        "sg14::trunc_add_result test failed");

////////////////////////////////////////////////////////////////////////////////
// sg14::trunc_add

static_assert(trunc_add(make_ufixed<7, 1>(127), make_ufixed<7, 1>(127))==254, "sg14::trunc_add test failed");
static_assert(trunc_add(make_ufixed<4, 4>(15.5), make_ufixed<4, 4>(14.25), make_ufixed<4, 4>(13.5))==43.25,
        "sg14::trunc_add test failed");
static_assert(trunc_add(make_fixed<7, 0>(-128), make_fixed<7, 0>(-128))==-256, "sg14::trunc_add test failed");

////////////////////////////////////////////////////////////////////////////////
// sg14::trunc_subtract_result

static_assert(is_same<trunc_subtract_result<make_ufixed<4, 4>>, make_fixed<5, 2>>::value,
        "sg14::trunc_subtract_result test failed");
static_assert(is_same<trunc_subtract_result<make_fixed<4, 3>, make_ufixed<8, 8>>, make_fixed<9, 6>>::value,
        "sg14::trunc_subtract_result test failed");
...
static_assert(trunc_subtract(make_ufixed<7, 1>(127.5), make_ufixed<7, 1>(0))==126.f,
        "sg14::trunc_subtract test failed");
static_assert(trunc_subtract(make_ufixed<7, 1>(0), make_ufixed<7, 1>(127.5))==-126.f,
        "sg14::trunc_subtract test failed");
...
static_assert(trunc_subtract(make_fixed<7, 0>(-128), make_fixed<7, 0>(127))==-254.f,
        "sg14::trunc_subtract test failed");

////////////////////////////////////////////////////////////////////////////////
// sg14::trunc_multiply_result

static_assert(trunc_multiply_result<fixed_point<uint8, -4>>::integer_digits==8,
        "sg14::trunc_multiply_result test failed");
static_assert(trunc_multiply_result<fixed_point<int32, -25>>::integer_digits==12,
        "sg14::trunc_multiply_result test failed");
static_assert(trunc_multiply_result<fixed_point<uint8, 0>>::integer_digits==16,
        "sg14::trunc_multiply_result test failed");
...
static_assert(trunc_multiply(make_ufixed<4, 4>(15.9375), make_ufixed<4, 4>(15.9375))==254,
        "sg14::trunc_multiply test failed");
static_assert(trunc_multiply(make_ufixed<4, 4>(0.0625), make_ufixed<4, 4>(0.0625))==0.f,
        "sg14::trunc_multiply test failed");
...
static_assert(trunc_divide_result<fixed_point<int32, -25>>::integer_digits==31,
        "sg14::trunc_divide_result test failed");
static_assert(trunc_divide_result<fixed_point<uint8, 0>>::integer_digits==8, "sg14::trunc_divide_result test failed");
static_assert(
        is_same<trunc_divide_result<make_fixed<15, 0, int8>, make_fixed<7, 8, int8>>, fixed_point<int16, 8>>::value,
        "sg14::trunc_divide_result test failed");
...
static_assert(trunc_divide(make_ufixed<4, 4>(0.0625), make_ufixed<4, 4>(0.0625))==1.f,
        "sg14::trunc_divide test failed");
static_assert(trunc_divide(make_ufixed<8, 0>(0), make_ufixed<8, 0>(1))==0.f, "sg14::trunc_divide test failed");
static_assert(trunc_divide(fixed_point<uint16, 0>(4096), make_ufixed<8, 0>(25))==163.,
        "sg14::trunc_divide test failed");
static_assert(trunc_divide(make_ufixed<14, 0>(4288), make_ufixed<6, 2>(25))==171, "sg14::trunc_divide test failed");
static_assert((trunc_divide(make_fixed<20>(1040352), make_ufixed<16, 0>(65535)))==15.87451171875,
        "sg14::trunc_divide test failed");
...
static_assert(is_same<trunc_reciprocal_result<fixed_point<uint8, -4>>, fixed_point<uint8, -3>>::value,
        "sg14::trunc_reciprocal_result test failed");
static_assert(is_same<trunc_reciprocal_result<make_fixed<4, 3>>, make_fixed<4, 3>>::value,
        "sg14::trunc_reciprocal_result test failed");
static_assert(is_same<trunc_reciprocal_result<fixed_point<int32, -25>>, fixed_point<int32, -5>>::value,
        "sg14::trunc_reciprocal_result test failed");
static_assert(is_same<trunc_reciprocal_result<fixed_point<uint8, 0>>, fixed_point<uint8, -7>>::value,
        "sg14::trunc_reciprocal_result test failed");
static_assert(is_same<trunc_reciprocal_result<make_fixed<15, 0, int8>>, fixed_point<int16, -14>>::value,
        "sg14::trunc_reciprocal_result test failed");
...
static_assert(is_same<trunc_square_result<make_ufixed<4, 4>>, make_ufixed<8, 0>>::value,
        "sg14::trunc_square_result test failed");
static_assert(is_same<trunc_square_result<make_fixed<6, 25>>, make_ufixed<12, 20>>::value,
        "sg14::trunc_square_result test failed");
...
static_assert(is_same<trunc_sqrt_result<make_ufixed<4, 4>>, make_ufixed<2, 6>>::value,
        "sg14::trunc_sqrt_result test failed");
static_assert(sizeof(trunc_sqrt_result<make_ufixed<4, 4>>)==sizeof(make_ufixed<2, 6>),
        "sg14::trunc_sqrt_result test failed");

static_assert(is_same<trunc_sqrt_result<make_ufixed<15, 16>>, make_ufixed<8, 24>>::value,
        "sg14::trunc_sqrt_result test failed");
static_assert(sizeof(trunc_sqrt_result<make_ufixed<15, 16>>)==sizeof(make_ufixed<8, 24>),
        "sg14::trunc_sqrt_result test failed");
...
static_assert(promote_add(make_ufixed<4, 4>(15.5), make_ufixed<4, 4>(14.25), make_ufixed<4, 4>(13.5))==43.25,
