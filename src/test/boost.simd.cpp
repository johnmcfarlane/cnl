...
TEST(boost_simd, _inequality) {
    using fpp = boost::simd::pack<unsigned long, 2>;
    auto lhs = fpp{8237416.17618, 3278928.9012393};
    auto rhs = fpp{8237416.17618, 4278928.9012393};
    auto e = boost::simd::compare_equal(lhs, rhs);
    ASSERT_TRUE(e);
}
