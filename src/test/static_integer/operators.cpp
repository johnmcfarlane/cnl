...
////        auto x = cnl::wide_integer<3>{6};
//        static_assert(
//                cnl::_impl::identical(
//                        6,
//                        cnl::_impl::to_rep(cnl::wide_integer<3>{6})));
...
//}
//
///home/john/ws/number/cnl/include/cnl/_impl/elastic_tag/generic.h:87:20: note: in instantiation of function template specialization
//
//cnl::_impl::add_op::operator()<
//        cnl::_impl::number<
//                cnl::_impl::number<
//                        long,
//                        cnl::wide_tag<31, int, void>>,
//                cnl::nearest_rounding_tag>,
//        cnl::_impl::number<
//                cnl::_impl::number<
//                        long,
//                        cnl::wide_tag<31, int, void>>,
//                cnl::nearest_rounding_tag> >' requested here
