...
namespace {
    ...
    namespace default_parameters {
        ...
        static_assert(is_same<rounding_integer<>::tag, default_tag<default_rep>>::value,
    ...
    namespace test_is_integer {
        static_assert(cnl::_impl::is_integer<rounding_integer<>>::value, "is_integer<rounding_integer<>>");
    }

    namespace test_from_value {
        static_assert(
                identical(
                        cnl::_impl::integer<int, cnl::native_rounding_tag>{42},
                        cnl::_impl::from_value<
                                cnl::_impl::integer<int, cnl::native_rounding_tag>,
                                cnl::_impl::integer<int, cnl::_impl::native_tag>>(42)),
                "");
    }
    ...
    namespace divide {
        ...
        static_assert(identical(
                ...
                cnl::binary_operator<
                        ...
                        cnl::_impl::divide_op,
                        cnl::_impl::integer<long, cnl::native_rounding_tag>,
                        cnl::constant<3>>{}(
                        cnl::_impl::integer<long, cnl::native_rounding_tag>{963},
                        cnl::constant<3>{})),
                "");
    }
