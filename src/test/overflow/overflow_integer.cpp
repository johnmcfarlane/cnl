...
static_assert(cnl::comparison_operator<cnl::_impl::equal_op, saturated_integer<uint8_t>, int>()(
...
namespace test_equal {
    static_assert(cnl::comparison_operator<cnl::_impl::equal_op, throwing_integer<short>, double>()(
...
namespace test_impl_from_rep {
    ...
    static_assert(identical(cnl::_impl::from_rep<native_integer<int>>(746352), native_integer<int>{746352}), "");
    static_assert(identical(cnl::_impl::from_rep<native_integer<short>>(1), native_integer<int>{1}), "");
    static_assert(identical(cnl::_impl::from_rep<throwing_integer<short>>(1), throwing_integer<int>{1}), "");
}
