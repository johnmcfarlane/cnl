...
namespace cnl {
    namespace _impl {
        ...
        template<class Operator, typename... Operands>
        int constexpr operator_overflow_traits<Operator, Operands...>::
                positive_digits; // NOLINT(readability-redundant-declaration)

        template<class Operator, typename... Operands>
        int constexpr operator_overflow_traits<Operator, Operands...>::
                negative_digits; // NOLINT(readability-redundant-declaration)
