...
namespace cnl {
    namespace _impl {
        ...
        struct overflow_digits<T, polarity::negative>
            : public std::integral_constant<int, cnl::is_signed<T> ? digits<T> : 0> {
        };
        ...
        template<typename Operand, bool IsSigned = is_signed<Operand>>
...
#pragma GCC diagnostic pop
        ...
        struct is_overflow<shift_left_op, polarity::negative> {
            ...
            CNL_NODISCARD constexpr auto operator()(Lhs const& lhs, Rhs const& rhs) const
                    -> enable_if_t<is_signed<Lhs>, bool>
            {
