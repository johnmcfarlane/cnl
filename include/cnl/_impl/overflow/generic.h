...
namespace cnl {
    namespace _impl {
        ...
        struct common_overflow_tag<
                ...
                enable_if_t<
                        ...
                        _impl::is_overflow_tag<OverflowTag>::value>> : type_identity<OverflowTag> {
        };
    ...
    struct unary_operator<
                ...
                -> _impl::op_result<Operator, Operand>
        {
            return _impl::is_overflow<Operator, _impl::polarity::positive>{}(operand)
                    ? _impl::overflow_operator<Operator, OverflowTag, _impl::polarity::positive>{}(
                              operand)
    ...
    struct binary_operator<
            ...
            _impl::enable_if_t<
                    _impl::is_overflow_tag<LhsTag>::value &&
