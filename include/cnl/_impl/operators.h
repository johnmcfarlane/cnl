...
namespace cnl {
    namespace _impl {
        ...
        ////////////////////////////////////////////////////////////////////////////////
        // cnl::_impl::is_comparison_operator

        template<class T>
        struct is_comparison_operator : std::false_type {
        };

        template<> struct is_comparison_operator<equal_op> : std::true_type {};
        template<> struct is_comparison_operator<not_equal_op> : std::true_type {};
        template<> struct is_comparison_operator<less_than_op> : std::true_type {};
        template<> struct is_comparison_operator<greater_than_op> : std::true_type {};
        template<> struct is_comparison_operator<less_than_or_equal_op> : std::true_type {};
        template<> struct is_comparison_operator<greater_than_or_equal_op> : std::true_type {};
