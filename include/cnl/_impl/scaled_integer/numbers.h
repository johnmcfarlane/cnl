...
namespace std {
    namespace numbers {
        /// \brief specialization of \ref std::numbers::e_v for \ref scaled_integer
        template<typename Rep, int Exponent>
