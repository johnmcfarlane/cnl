...
namespace cnl {
    ...
    struct numeric_limits<_impl::integer<Rep, Tag> const>
            : numeric_limits<_impl::integer<Rep, Tag>> {
    };
}
...
namespace std {
    ...
    template<typename Rep, class Tag>
    struct numeric_limits<cnl::_impl::integer<Rep, Tag>>
            : cnl::numeric_limits<cnl::_impl::integer<Rep, Tag>> {
    };

    template<typename Rep, class Tag>
    struct numeric_limits<cnl::_impl::integer<Rep, Tag> const>
            : cnl::numeric_limits<cnl::_impl::integer<Rep, Tag>> {
    };
}
