...
#if !defined(CNL_IMPL_INTEGER_COMPARISON_OPERATOR_H)
#define CNL_IMPL_INTEGER_COMPARISON_OPERATOR_H
...
namespace cnl {
    ...
    struct comparison_operator<Operator, _impl::integer<LhsRep, Tag>, _impl::integer<RhsRep, Tag>> {
...
#endif  // CNL_IMPL_INTEGER_COMPARISON_OPERATOR_H
