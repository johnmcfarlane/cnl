...
namespace cnl {
    ...
    struct shift_operator<
        ...
        -> decltype(_impl::from_rep<_impl::integer<LhsRep, LhsTag>>(Operator()(_impl::to_rep(lhs), rhs)))
        {
            return _impl::from_rep<_impl::integer<LhsRep, LhsTag>>(Operator()(_impl::to_rep(lhs), rhs));
        }
    };
