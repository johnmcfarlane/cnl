...
namespace cnl::_impl {
    ...
    template<std::uint32_t Digits2, typename LimbType, typename AllocatorType, bool IsSigned>
    inline constexpr auto is_uintwide_v<
            math::wide_integer::uintwide_t<Digits2, LimbType, AllocatorType, IsSigned>> = true;
    ...
    struct make_uintwide {
        ...
        static constexpr auto min_width{Digits + is_signed};
...
namespace cnl {
    template<std::uint32_t Digits2, typename LimbType, typename AllocatorType, const bool IsSigned>
    struct is_integer<
...
namespace cnl::numbers {
    template<std::uint32_t Digits2, typename LimbType, typename AllocatorType, bool IsSigned>
    struct signedness<math::wide_integer::uintwide_t<Digits2, LimbType, AllocatorType, IsSigned>>
