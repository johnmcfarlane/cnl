...
namespace cnl {
    ...
    inline constexpr int
            digits_v<math::wide_integer::uintwide_t<Width, LimbType, AllocatorType, false>> = Width;

    template<std::uint32_t Width, typename LimbType, typename AllocatorType>
    inline constexpr int
            digits_v<math::wide_integer::uintwide_t<Width, LimbType, AllocatorType, true>> = Width - 1;

    template<std::uint32_t Width, typename LimbType, typename AllocatorType, bool IsSigned,
                typename Value>
    struct from_value<
            math::wide_integer::uintwide_t<Width, LimbType, AllocatorType, IsSigned>,
            Value> {
        [[nodiscard]] constexpr auto operator()(Value const& value) const
        {
            constexpr auto _width = _impl::width<Value>;
            constexpr auto _is_signed = numbers::signedness_v<Value>;
            using result_type = math::wide_integer::uintwide_t<_width, LimbType, AllocatorType, _is_signed>;
...
namespace cnl::numbers {
    template<std::uint32_t Width, typename LimbType, typename AllocatorType, bool IsSigned>
    struct signedness<math::wide_integer::uintwide_t<Width, LimbType, AllocatorType, IsSigned>>
