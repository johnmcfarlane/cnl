...
namespace cnl {
    ...
    struct unary_operator<_impl::native_tag, Operator, _impl::number<Rep, Tag>> {
        ...
        -> decltype(_impl::number_from_rep<Tag>(unary_operator<Tag, Operator, Rep>{}(_impl::to_rep(rhs))))
        {
            return _impl::number_from_rep<Tag>(unary_operator<Tag, Operator, Rep>{}(_impl::to_rep(rhs)));
        }
    };
}
