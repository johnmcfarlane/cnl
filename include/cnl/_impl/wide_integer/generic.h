...
//    struct unary_operator<Operator, _impl::native_tag, wide_integer<Digits, Narrowest>> {
//        CNL_NODISCARD constexpr auto operator()(
//                wide_integer<Digits, Narrowest> const& rhs) const -> wide_integer<Digits, Narrowest>
//        {
...
//    };
    ...
    struct binary_operator<
        ...
        using lhs_type = wide_integer<LhsDigits, LhsNarrowest>;
        using rhs_type = wide_integer<RhsDigits, RhsNarrowest>;
...
//            wide_integer<LhsDigits, LhsNarrowest>, Rhs,
...
//    struct pre_operator<Operator, _impl::native_tag, wide_integer<Digits, Narrowest>> {
...
//
//    template<class Operator, int Digits, typename Narrowest>
//    struct post_operator<Operator, _impl::native_tag, wide_integer<Digits, Narrowest>> {
