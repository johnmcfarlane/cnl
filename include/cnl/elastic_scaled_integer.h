...
namespace cnl {
    ...
    /// \snippet snippets.cpp define an int-sized object using make_elastic_scaled_integer and
    /// constant
    ...
    /// \snippet snippets.cpp define a byte-sized object using \ref make_elastic_scaled_integer and
    /// \ref _c
    ///
    /// \brief generate an \ref cnl::elastic_scaled_integer object of given value
