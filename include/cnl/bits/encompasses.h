...
namespace cnl {
    namespace _impl {
        ...
        struct encompasses_lower : std::false_type {
        };
        ...
        struct encompasses_lower<Encompasser, Encompassed,
            ...
            std::integral_constant<bool, (numeric_limits<Encompasser>::lowest()
        ...
        template<class Encompasser, class Encompassed>
        struct encompasses_upper
        : std::integral_constant<bool, static_cast<unsigned_or_float_t<Encompasser>>(numeric_limits<Encompasser>::max())
        ...
        struct encompasses {
            ...
            static constexpr bool _upper = encompasses_upper<Encompasser, Encompassed>::value;
