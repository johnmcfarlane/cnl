...
namespace cnl {
    ...
    template<
            int Digits, int Exponent = 0, class RoundingTag = nearest_rounding_tag,
            class OverflowTag = undefined_overflow_tag, class Narrowest = signed>
    ...
    template<
            class RoundingTag = nearest_rounding_tag, class OverflowTag = undefined_overflow_tag,
    ...
    template<
            class RoundingTag = _impl::tag_of_t<rounding_integer<>>,
            class OverflowTag = _impl::tag_of_t<overflow_integer<>>, class Narrowest = int,
