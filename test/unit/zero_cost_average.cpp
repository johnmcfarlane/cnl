...
constexpr auto average_integer(float input1, float input2)
{
...
constexpr auto average_elastic_integer(float input1, float input2)
{
...
constexpr auto average_scaled_integer(float input1, float input2)
{
...
constexpr auto average_elastic(float input1, float input2)
{
