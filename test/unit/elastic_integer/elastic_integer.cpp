...
namespace {
    ...
    namespace test_operate {
        ...
        static_assert(
                cnl::comparison_operator<
                        cnl::_impl::greater_than_op, elastic_integer<31>, elastic_integer<31>>()(
        ...
        static_assert(
                cnl::comparison_operator<
                        cnl::_impl::less_than_op, elastic_integer<31, signed>,
                        elastic_integer<31, unsigned>>{}(
        ...
        static_assert(
                ...
                "cnl::elastic_integer test failed");
        static_assert(
                cnl::comparison_operator<cnl::_impl::equal_op, elastic_integer<1>, std::int32_t>()(
        ...
        static_assert(
                cnl::comparison_operator<equal_op, elastic_integer<8>, elastic_integer<8>>()(
                        elastic_integer<8>{1L}, elastic_integer<8>{1}),
                "elastic_integer comparison test failed");
        static_assert(
                cnl::comparison_operator<equal_op, elastic_integer<12, cnl::uint16>, int>()(
    ...
    namespace test_unary_add {
        static_assert(
                identical(+elastic_integer<1, unsigned>{1}, elastic_integer<1, unsigned>{1}),
                "elastic_integer test failed");
    }
    ...
    namespace test_subtract {
        ...
        static_assert(
                identical(
                        elastic_integer<5, unsigned>{0}
                                - cnl::numeric_limits<elastic_integer<5, unsigned>>::max(),
        ...
        static_assert(
                identical(
                        -cnl::numeric_limits<elastic_integer<7>>::max()
                                - cnl::numeric_limits<elastic_integer<4, unsigned>>::max(),
    ...
    namespace test_add {
        ...
        static_assert(
                identical(
                        cnl::numeric_limits<elastic_integer<15, unsigned>>::max()
                                + cnl::numeric_limits<elastic_integer<19>>::max(),
        ...
        static_assert(
                identical(
                        cnl::numeric_limits<elastic_integer<10>>::max()
                                - cnl::numeric_limits<elastic_integer<9>>::max(),
        ...
        static_assert(
                identical(
                        ...
                        cnl::shift_operator<
                                ...
                                cnl::_impl::native_tag, elastic_integer<39, unsigned>, int>{}(
