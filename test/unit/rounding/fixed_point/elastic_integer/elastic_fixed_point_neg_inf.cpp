...
namespace {
    ...
    template<
            int Digits, int Exponent = 0, class RoundingTag = cnl::neg_inf_rounding_tag,
            class Narrowest = signed>
    using elastic_fixed_point_neg_inf =
    ...
    namespace elastic_fixed_point_neg_inf_implicit_conversions {
        using q4_4 = elastic_fixed_point_neg_inf<8, -4>;
        using q4_1 = elastic_fixed_point_neg_inf<5, -1>;
        ...
        static_assert(
                ...
                "conversion 4 (elastic_fixed_point_neg_inf)");
    }

    namespace elastic_fixed_point_neg_inf_multiply {
        using q4_20 = elastic_fixed_point_neg_inf<24, -20>;
        using q4_4 = elastic_fixed_point_neg_inf<8, -4>;
        using q4_1 = elastic_fixed_point_neg_inf<5, -1>;
