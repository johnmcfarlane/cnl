...
namespace {
    ...
    namespace efxp_tie_to_pos_inf_round_test {
        template<
                int IntegerDigits,
        ...
        using T0 = elastic_fixed_point_tie_to_pos_inf<24, -20>;
        using T1 = elastic_fixed_point_tie_to_pos_inf<16, -8>;
        using T2 = elastic_fixed_point_tie_to_pos_inf<8, -4>;
        using T3 = elastic_fixed_point_tie_to_pos_inf<5, -1>;
    }

    namespace elastic_fixed_point_tie_to_pos_inf_implicit_conversions {
        using efxp_tie_to_pos_inf_round_test::T1;
        using efxp_tie_to_pos_inf_round_test::T2;
        using efxp_tie_to_pos_inf_round_test::T3;
    ...
    namespace elastic_fixed_point_tie_to_pos_inf_multiply {
        using efxp_tie_to_pos_inf_round_test::T0;
        using efxp_tie_to_pos_inf_round_test::T2;
        using efxp_tie_to_pos_inf_round_test::T3;
