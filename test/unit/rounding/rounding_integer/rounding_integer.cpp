        ...
        static_assert(
                cnl::_impl::identical(
                        ...
                        cnl::binary_operator<
                                ...
                                cnl::_impl::number<int, cnl::nearest_rounding_tag>, int>{}(
                                cnl::_impl::number<int, cnl::nearest_rounding_tag>{6}, 9)),
                "binary_operator<multiply_op, native_tag, native_tag, nearest_rounding_integer, "
                "int>");
