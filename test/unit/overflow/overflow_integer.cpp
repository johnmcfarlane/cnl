...
static_assert(
        cnl::comparison_operator<cnl::_impl::equal_op, saturated_integer<uint8_t>, int>()(
...
static_assert(
        saturated_integer<int8_t>(
                saturated_integer<int8_t>(100) + saturated_integer<int8_t>(100)) ==
                cnl::numeric_limits<int8_t>::max(),
        "cnl::saturated_integer test failed");
...
static_assert(
        cnl::numeric_limits<cnl::overflow_integer<int8_t, cnl::saturated_overflow_tag>>::is_integer,
...
static_assert(
        cnl::numeric_limits<cnl::overflow_integer<int8_t, cnl::saturated_overflow_tag>>::is_signed,
        "cnl::numeric_limits<cnl::overflow_integer<>> test failed");
static_assert(
        !cnl::numeric_limits<
...
static_assert(
        ...
        "cnl::numeric_limits<cnl::overflow_integer<>> test failed");
static_assert(
        cnl::numeric_limits<cnl::overflow_integer<int32_t, cnl::saturated_overflow_tag>>::is_signed,
        "cnl::numeric_limits<cnl::overflow_integer<>> test failed");
static_assert(
        !cnl::numeric_limits<
        ...
        "cnl::numeric_limits<cnl::overflow_integer<>> test failed");
static_assert(
        cnl::numeric_limits<cnl::overflow_integer<int64_t, cnl::saturated_overflow_tag>>::is_signed,
        "cnl::numeric_limits<cnl::overflow_integer<>> test failed");
static_assert(
        !cnl::numeric_limits<
...
static_assert(
        std::numeric_limits<
                cnl::overflow_integer<int8_t, cnl::saturated_overflow_tag>>::is_specialized,
        "std::numeric_limits<cnl::overflow_integer<>> test failed");
static_assert(
        std::numeric_limits<
                cnl::overflow_integer<uint8_t, cnl::saturated_overflow_tag> const>::is_specialized,
        "std::numeric_limits<cnl::overflow_integer<>> test failed");
static_assert(
        std::numeric_limits<
                cnl::overflow_integer<int16_t, cnl::saturated_overflow_tag>>::is_specialized,
        "std::numeric_limits<cnl::overflow_integer<>> test failed");
static_assert(
        std::numeric_limits<
                cnl::overflow_integer<uint16_t, cnl::saturated_overflow_tag>>::is_specialized,
        "std::numeric_limits<cnl::overflow_integer<>> test failed");
static_assert(
        std::numeric_limits<
                cnl::overflow_integer<int32_t, cnl::saturated_overflow_tag> const>::is_specialized,
        "std::numeric_limits<cnl::overflow_integer<>> test failed");
static_assert(
        std::numeric_limits<
                cnl::overflow_integer<uint32_t, cnl::saturated_overflow_tag>>::is_specialized,
        "std::numeric_limits<cnl::overflow_integer<>> test failed");
static_assert(
        std::numeric_limits<
                cnl::overflow_integer<int64_t, cnl::saturated_overflow_tag>>::is_specialized,
        "std::numeric_limits<cnl::overflow_integer<>> test failed");
static_assert(
        std::numeric_limits<
                cnl::overflow_integer<uint64_t, cnl::saturated_overflow_tag> const>::is_specialized,
        "std::numeric_limits<cnl::overflow_integer<>> test failed");
#if defined(CNL_INT128_ENABLED)
static_assert(
        std::numeric_limits<
...
static_assert(
        std::numeric_limits<
                cnl::overflow_integer<cnl::uint128, cnl::saturated_overflow_tag>>::is_specialized,
        "std::numeric_limits<cnl::overflow_integer<>> test failed");
#endif
...
static_assert(
        std::numeric_limits<
                cnl::overflow_integer<int8_t, cnl::saturated_overflow_tag> const>::is_integer,
        "std::numeric_limits<cnl::overflow_integer<>> test failed");
static_assert(
        std::numeric_limits<
                cnl::overflow_integer<uint8_t, cnl::saturated_overflow_tag>>::is_integer,
...
static_assert(
        std::numeric_limits<
                cnl::overflow_integer<int16_t, cnl::saturated_overflow_tag>>::is_integer,
        "std::numeric_limits<cnl::overflow_integer<>> test failed");
static_assert(
        std::numeric_limits<
                cnl::overflow_integer<uint16_t, cnl::saturated_overflow_tag> const>::is_integer,
        "std::numeric_limits<cnl::overflow_integer<>> test failed");
static_assert(
        std::numeric_limits<
                cnl::overflow_integer<int32_t, cnl::saturated_overflow_tag>>::is_integer,
...
static_assert(
        std::numeric_limits<
                cnl::overflow_integer<uint32_t, cnl::saturated_overflow_tag>>::is_integer,
        "std::numeric_limits<cnl::overflow_integer<>> test failed");
static_assert(
        std::numeric_limits<
                cnl::overflow_integer<int64_t, cnl::saturated_overflow_tag> const>::is_integer,
        "std::numeric_limits<cnl::overflow_integer<>> test failed");
static_assert(
        std::numeric_limits<
                cnl::overflow_integer<uint64_t, cnl::saturated_overflow_tag>>::is_integer,
...
namespace test_add_signedness {
    ...
    static_assert(
            is_same<add_signedness<saturated_integer<int8_t>>::type,
                    saturated_integer<int8_t>>::value,
            "cnl::add_signedness<cnl::saturated_integer<>> test failed");
    static_assert(
            is_same<add_signedness<saturated_integer<uint8_t>>::type,
                    saturated_integer<int8_t>>::value,
            "cnl::add_signedness<cnl::saturated_integer<>> test failed");
    static_assert(
            is_same<add_signedness<saturated_integer<int16_t>>::type,
                    saturated_integer<int16_t>>::value,
            "cnl::add_signedness<cnl::saturated_integer<>> test failed");
    static_assert(
            is_same<add_signedness<saturated_integer<uint16_t>>::type,
                    saturated_integer<int16_t>>::value,
            "cnl::add_signedness<cnl::saturated_integer<>> test failed");
    static_assert(
            is_same<add_signedness<saturated_integer<int32_t>>::type,
                    saturated_integer<int32_t>>::value,
            "cnl::add_signedness<cnl::saturated_integer<>> test failed");
    static_assert(
            is_same<add_signedness<saturated_integer<uint32_t>>::type,
                    saturated_integer<int32_t>>::value,
            "cnl::add_signedness<cnl::saturated_integer<>> test failed");
    static_assert(
            is_same<add_signedness<saturated_integer<int64_t>>::type,
                    saturated_integer<int64_t>>::value,
            "cnl::add_signedness<cnl::saturated_integer<>> test failed");
    static_assert(
            is_same<add_signedness<saturated_integer<uint64_t>>::type,
                    saturated_integer<int64_t>>::value,
            "cnl::add_signedness<cnl::saturated_integer<>> test failed");
}
...
namespace test_remove_signedness {
    ...
    // cnl::remove_signedness<cnl::saturated_integer<>>
    static_assert(
            is_same<remove_signedness<saturated_integer<int8_t>>::type,
                    saturated_integer<uint8_t>>::value,
            "cnl::remove_signedness<cnl::saturated_integer<>>::type test failed");
    static_assert(
            is_same<remove_signedness<saturated_integer<uint8_t>>::type,
                    saturated_integer<uint8_t>>::value,
            "cnl::remove_signedness<cnl::saturated_integer<>>::type test failed");
    static_assert(
            is_same<remove_signedness<saturated_integer<int16_t>>::type,
                    saturated_integer<uint16_t>>::value,
            "cnl::remove_signedness<cnl::saturated_integer<>>::type test failed");
    static_assert(
            is_same<remove_signedness<saturated_integer<uint16_t>>::type,
                    saturated_integer<uint16_t>>::value,
            "cnl::remove_signedness<cnl::saturated_integer<>>::type test failed");
    static_assert(
            is_same<remove_signedness<saturated_integer<int32_t>>::type,
                    saturated_integer<uint32_t>>::value,
            "cnl::remove_signedness<cnl::saturated_integer<>>::type test failed");
    static_assert(
            is_same<remove_signedness<saturated_integer<uint32_t>>::type,
                    saturated_integer<uint32_t>>::value,
            "cnl::remove_signedness<cnl::saturated_integer<>>::type test failed");
    static_assert(
            is_same<remove_signedness<saturated_integer<int64_t>>::type,
                    saturated_integer<uint64_t>>::value,
            "cnl::remove_signedness<cnl::saturated_integer<>>::type test failed");
    static_assert(
            is_same<remove_signedness<saturated_integer<uint64_t>>::type,
                    saturated_integer<uint64_t>>::value,
            "cnl::remove_signedness<cnl::saturated_integer<>>::type test failed");
}
