...
static_assert(
        scaled_integer<uint32, cnl::power<-24>>(
                scaled_integer<uint64, cnl::power<-48>>(3.141592654)) > 3.1415923F,
        "cnl::scaled_integer test failed");
static_assert(
        scaled_integer<uint32, cnl::power<-24>>(
                scaled_integer<uint64, cnl::power<-48>>(3.141592654)) < 3.1415927F,
        "cnl::scaled_integer test failed");
...
static_assert(
        (scaled_integer<int32, cnl::power<-16>>(123.125) +
         scaled_integer<int32, cnl::power<-16>>(123.75)) == 246.875,
        "cnl::scaled_integer addition operator test failed");
static_assert(
        (scaled_integer<int32, cnl::power<-16>>(123.125) +
         scaled_integer<int32, cnl::power<-16>>(123.75)) == 246.875,
...
static_assert(
        (scaled_integer<int32, cnl::power<-16>>(246.875) -
         scaled_integer<int32, cnl::power<-16>>(123.75)) == 123.125,
        "cnl::scaled_integer test failed");
static_assert(
        (scaled_integer<int16, cnl::power<-4>>(123.125) -
         scaled_integer<int16, cnl::power<-4>>(246.875)) == -123.75,
        "cnl::scaled_integer test failed");
