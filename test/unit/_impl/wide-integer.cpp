...
static_assert(
        std::is_same_v<
                std::uint64_t,
                math::wide_integer::detail::uint_type_helper<64>::exact_unsigned_type>);

static_assert(
        identical(
                cnl::_impl::from_value<math::wide_integer::uintwide_t<160, unsigned int, void, true>>(42),
                math::wide_integer::uintwide_t<32, unsigned int, void, true>(42)),
        "cnl::_impl::from_value<math::wide_integer::uintwide_t>");
